...
class ResetPasswordController extends AbstractController
{
     ...
     * Validates and process the reset URL that the user clicked in their email.
     */
    #[Route('/reset-mdp', name: 'app_reset_mdp')]
    public function resetMdp(Request $request, UserPasswordHasherInterface $userPasswordHasherInterface): Response
    {
